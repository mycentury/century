 ...
 */
public class RandomAccessFileExtension extends RandomAccessFile {
	...
	public RandomAccessFileExtension(String name, String mode)
	...
	public RandomAccessFileExtension(File file, String mode)
			throws FileNotFoundException {
		super(file, mode);
		this.setBuffer(new byte[1024 * 10]);
		bufferLines = new ArrayList<String>();
